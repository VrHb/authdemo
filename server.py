...
def sign_data(data: str) -> str:
    """Возвращает данные из data, получаем hash из данных c использованием 
    SECRET_KEY"""
    return hmac.new(
        # Ключ в байтах
        SECRET_KEY.encode(),
...
"""
------------------------------------------------------------------------------
base64 для username нужеен по факту просто чтобы убрать точки в username
------------------------------------------------------------------------------
"""
...
"""
------------------------------------------------------------------------------
Ниже в  нашей "БД" мы храним хэш паролей, сгенерерированные в интерактивном
режиме с помощью:
1. import hashlib
